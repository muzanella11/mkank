...
export const FETCH_LIST_BUYER = `${NAMESPACE}_FETCH_LIST_BUYER`
export const FETCH_MAPS_BUYER = `${NAMESPACE}_FETCH_MAPS_BUYER`
/*******************************************************************************/

/** ************************ For Getters ****************************************/
export const GET_ENTRIES_FEATURE = `${NAMESPACE}_GET_ENTRIES_FEATURE`
export const GET_FILTERS_FEATURE = `${NAMESPACE}_GET_FILTERS_FEATURE`
/*******************************************************************************/
